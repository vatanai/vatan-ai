...
return [
    'events' => [
        ...
        'first_image_followup' => [
            'label' => 'پیام بعد از اینکه کاربر اولین عکس خودش رو ساخت',
            'group' => 'کاربران',
            'variables' => ['name'],
            'delay_minutes' => 30,
            'send_window' => ['from' => '10:00', 'until' => '23:00'],
        ],
    ...
    'approved_shared_templates' => [
        ...
        'first_image_followup' => ['provider_template_id' => '529239', 'variables' => ['name']],
