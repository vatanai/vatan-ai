...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $templates = [
            ...
            'registration_success' => [
                ...
                'body' => '{name} جان از اینکه به وطن خودت رسیدی خوشحالیم... برای شروع، حسابت رو با چند اعتبار هدیه شارژ کردیم؛ حالا وقتشه ایده‌هات رو بسازی. وطن استودیو',
                'body_id' => '506692',
                'variables' => ['name'],
            ],
    ...
    public function down(): void
    {
        DB::table('sms_templates')
            ...
            ->update(['provider_approval_status' => 'pending']);
    }
};
