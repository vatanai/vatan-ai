...
class SitemapService
{
    public function entries(): Collection
    {
        $urls = collect([
            ...
            ['loc' => route('landing.character-sheet'), 'section' => 'discover', 'title' => 'کارکتر شیت', 'description' => 'راهنمای ساخت کارکتر شیت چهره و بدن با سه محصول آماده وطن.', 'icon' => 'fa-user-astronaut'],
