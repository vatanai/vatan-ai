...
/**
 * قوانین اعتبارسنجی به‌روزرسانی مدل هوش مصنوعی.
 * (استخراج‌شده از AiModelController@update در فرایند استانداردسازی — قوانین بدون تغییر)
 */
class UpdateAiModelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'provider'             => 'nullable|string|in:openrouter,fal,replicate',
            ...
            'lab_categories'       => 'nullable|array',
            'lab_categories.*'     => 'string|in:popular,identity,economic,vip,experimental',
            'lab_priority'         => 'nullable|integer|min:1|max:9999',
            'featured_in_lab'      => 'nullable|boolean',
            'lab_status'           => 'nullable|string|in:active,experimental',
            'lab_description'      => 'nullable|string|max:4000',
