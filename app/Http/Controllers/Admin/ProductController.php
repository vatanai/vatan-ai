...
{
    /**
     * نمایش لیست محصولات با صفحه‌بندی برای هماهنگی با متد total()
     */
    ...
    public function store(Request $request)
    {
        ...
        // آپلود تصاویر چندگانه نمونه خروجی
        $samplePaths = [];
