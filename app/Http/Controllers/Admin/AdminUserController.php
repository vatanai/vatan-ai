...
class AdminUserController extends Controller
{
    ...
    {
        $plans = app(PlanCatalogService::class)->publicPricingPlans();
    ...
    public function allLogs()
    {
        ...
        return view('admin.users.all-logs', compact('generatedImages'));
    }
    ...
    public function logs($id)
    {
        ...
        return view('admin.users.logs', compact('user', 'activities', 'generatedImages'));
    }
