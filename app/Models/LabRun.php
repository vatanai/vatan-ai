...
class LabRun extends Model
{
    ...
    protected $casts = [
        ...
        'estimated_cost_usd' => 'decimal:6', 'actual_cost_usd' => 'decimal:6', 'cost' => 'decimal:6', 'estimated_cost_toman' => 'decimal:2', 'actual_cost_toman' => 'decimal:2', 'final_score' => 'decimal:2', 'quality_score' => 'decimal:2', 'identity_score' => 'decimal:2', 'sample_match_score' => 'decimal:2', 'is_selected' => 'boolean', 'preserve_face' => 'boolean', 'exchange_rate_irr' => 'decimal:2',
        'build_seconds' => 'integer', 'latency_ms' => 'integer', 'tokens_used' => 'integer',
