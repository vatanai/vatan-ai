    ...
    $privacySections = [
        ...
        [
            ...
            'paragraphs' => [
                ...
                , 'محتوای ورودی و خروجی کاربر برای نمایش در پروفایل کاربری، تاریخچه، پشتیبانی و کنترل کیفیت، فقط برای مدت محدود و متناسب با نیاز سرویس نگهداری می‌شود. پس از پایان این مدت یا در صورت حذف و درخواست معتبر کاربر، محتوا طبق محدودیت‌های فنی، امنیتی و قانونی حذف یا ناشناس‌سازی خواهد شد.'
            ],
        ],
        [
