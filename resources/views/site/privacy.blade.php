    ...
    $privacySections = [
        [
            ...
            'items' => [
                ...
                'اطلاعات مربوط به اعتبار‌ها، بسته‌ها و اشتراک‌ها؛',
        ...
        [
            'title' => 'مسئولیت محتوای تولیدشده',
            'paragraphs' => [
                'مسئولیت ساخت، انتخاب، استفاده و انتشار هر تصویر یا محتوایی که با ابزارهای وطن تولید می‌شود، بر عهده کاربر درخواست‌کننده است و وطن صرفاً زیرساخت فنی ارائه این خدمت را فراهم می‌کند.',
                'کاربر متعهد است از ساخت یا انتشار محتوای مجرمانه، توهین‌آمیز، خشونت‌آمیز، سیاسیِ خلاف قوانین، ضد مذهبی، ضد حکومتی یا محتوایی که حقوق، حریم خصوصی یا مالکیت فکری دیگران را نقض می‌کند، خودداری کند.',
                'هرگونه پیامد قانونی، اجتماعی یا مالی ناشی از ورودی‌ها و خروجی‌های کاربر بر عهده خود اوست و وطن حق دارد در صورت مشاهده سوءاستفاده یا نقض قوانین، محتوا یا دسترسی مربوط را بررسی، محدود یا حذف کند.'
            ],
        ],
        [
