...
<div class="pricing-page bg-[#0a0a0c] [.light_&]:bg-white text-white [.light_&]:text-black min-h-screen py-12 px-4 md:px-8 overflow-x-hidden" dir="rtl">
    ...
    <main class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch mb-20">
        ...
        @forelse($plans as $plan)
            ...
            <div class="pricing-card rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 relative bg-[#111116] [.light_&]:bg-white border border-[#222230] [.light_&]:border-[#E5E6E6] hover:border-[#333345] [.light_&]:hover:border-[#cffe00]/40 [.light_&]:shadow-sm">
