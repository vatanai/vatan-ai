...
<div class="catalog-page" dir="rtl">
  <div class="page-container catalog-shell">
    <header class="catalog-hero">
      <div>
        @if($pageCategory && $pageCategory->image)
          <div class="catalog-category-cover catalog-category-cover--{{ str_replace(':', '-', $pageCategory->coverAspectRatio()) }}"><img src="{{ asset('storage/'.$pageCategory->image) }}" alt="{{ $pageCategory->name_fa }}" loading="eager"></div>
        @endif
