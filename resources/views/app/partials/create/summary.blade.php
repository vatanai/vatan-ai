...
<div class="cp-summary">
  <div class="cp-summary__inner" style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:16px;padding:16px;">
    ...
    <button type="submit" id="cp-submit-btn" class="cp-cta"
      style="width:100%;height:52px;background:#cffe00;border:none;border-radius:14px;font-size:15px;font-weight:800;color:#12160a;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;font-family:inherit;transition:opacity 0.18s,transform 0.14s;">
