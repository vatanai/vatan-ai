...
<div class="w-full flex flex-col gap-4 mt-1" id="pdpOptions">
  ...
  <div class="pt-1">
    <button type="button" onclick="window.location.href='{{ auth()->check() ? route('app.create.product', $product->route_slug) : route('login') }}'" class="vatan-gen-btn" aria-label="شروع ساخت">
