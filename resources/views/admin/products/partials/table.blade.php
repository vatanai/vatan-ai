...
<form id="bulk-action-form" method="POST" action="{{ route('admin.products.bulk_action') }}">
  ...
  <div id="bulk-toolbar" class="bulk-toolbar" style="display:none;">
    ...
    <button type="button" class="btn-pro btn-pro-ghost" onclick="exportSelectedProducts()" title="خروجی بک‌آپ محصولات انتخاب‌شده"><i class="fa-solid fa-file-export text-[11px]"></i> خروجی انتخاب‌شده</button>
  ...
  <table class="table-pro products-table-compact">
    <thead>
      <tr>
        ...
        <th>آخرین ویرایش</th>
        <th><span class="block">عملیات</span><span class="block">لینک</span></th>
      </tr>
    </thead>
    <tbody>
