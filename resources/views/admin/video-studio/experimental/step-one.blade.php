    ...
    <div class="v2-modern-font-grid">
      @foreach($fonts->take(6) as $font)
        <div class="v2-modern-font">
          ...
          <label for="v2-modern-font-{{ $font->slug }}" style="font-family:'{{ $font->slug }}' !important">متن نمونهٔ هوک</label>
        </div>
      @endforeach
    </div>
  </section>
