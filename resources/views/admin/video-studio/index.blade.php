        ...
        <div class="studio-queue">
          @foreach($jobs as $job)
            ...
            <div class="studio-job">
              ...
              @if($jobStatus === 'failed')<form method="POST" action="{{ route('admin.video-studio.jobs.retry', $job) }}">@csrf<button class="studio-link-btn" type="submit" title="تلاش مجدد"><i class="fa-solid fa-rotate-left"></i></button></form>@else<span></span>@endif
            </div>
          @endforeach
        </div>
      @else
