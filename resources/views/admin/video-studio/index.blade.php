...
<style>
  ...
  .video-studio-head{order:0}.studio-grid{order:2}.studio-settings{order:1}#studio-system-layout{order:4}#studio-queue-panel{order:5}#studio-produced-panel{order:6}#studio-latest-videos-panel{order:7}#studio-latest-tests-panel{order:8}.studio-library-grid{order:9}.studio-modal{order:99}
