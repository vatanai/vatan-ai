...
<main class="mr-[294px] flex-1 min-h-screen flex flex-col min-w-0 max-[900px]:mr-0">
  ...
  <div class="admin-content orders-page p-6 flex-1 overflow-y-auto max-[768px]:p-[18px] max-[480px]:p-[14px]" id="content" dir="rtl">
    ...
    <div class="orders-head">
      ...
      <div class="orders-actions"><a class="order-btn" href="{{ url()->current() }}"><i class="fa-solid fa-rotate-right"></i> بروزرسانی</a><a class="order-btn" href="{{ route('admin.orders.plan-purchases') }}"><i class="fa-solid fa-credit-card"></i> خرید پلن‌ها</a><a class="order-btn" href="{{ route('admin.orders.analytics') }}"><i class="fa-solid fa-chart-line"></i> گزارش‌ها</a></div>
    </div>
