...
@section('title', 'درگاه پرداخت — وطن استودیو Admin')
...
<header class="admin-header">
  <div style="font-size:14px;font-weight:700;">درگاه پرداخت</div>
...
<main class="admin-content">
  <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh;gap:16px;text-align:center;">
    ...
    <div style="font-size:18px;font-weight:800;color:var(--text);">درگاه پرداخت</div>
    <div style="font-size:13px;color:var(--text2);max-width:400px;line-height:1.8;">تنظیمات درگاه‌های پرداخت (زرین‌پال و سایر) و پیکربندی آن‌ها در دست ساخت است.</div>
    <div style="display:flex;gap:8px;flex-wrap:wrap;justify-content:center;margin-top:8px;"><span style="font-size:11px;padding:4px 12px;border-radius:99px;background:rgba(160,122,245,.08);color:var(--accent);border:1px solid rgba(160,122,245,.2);">زرین‌پال</span><span style="font-size:11px;padding:4px 12px;border-radius:99px;background:rgba(160,122,245,.08);color:var(--accent);border:1px solid rgba(160,122,245,.2);">تست/لایو</span></div>
  </div>
</main>
@endsection
