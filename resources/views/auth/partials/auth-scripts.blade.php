<script>
  ...
  async function completeProfile(){
    ...
    try{const data=await jsonRequest('/auth/unified/register',{phone:authState.phone,name,last_name:last,email,birth_day:day,birth_month:month,birth_year:year});localStorage.setItem('show_welcome_modal','true');localStorage.setItem('user_first_name',data.user_name||name);window.location.href=data.redirect}
