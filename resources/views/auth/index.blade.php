    ...
    <section class="auth-form-col">
      ...
      <div id="step-stage" class="step-stage">
        ...
        <div class="auth-step" id="step-profile">
          ...
          <div class="auth-profile-height-reserver" aria-hidden="true"></div>
          <label class="auth-consent" for="gallery-consent">
            <input type="checkbox" id="gallery-consent">
            <span>با ذخیره‌سازی عکس‌های ورودی برای مدیریت و پشتیبانی موافقم. <a href="{{ route('privacy') }}" target="_blank" rel="noopener noreferrer">قوانین، شرایط استفاده و حریم خصوصی وطن</a> را مطالعه کرده‌ام.</span>
          </label>
          <div class="field-error hidden" id="gallery-consent-error">برای ساخت حساب، پذیرش قوانین و رضایت ذخیره‌سازی ورودی‌ها لازم است.</div>
